...
<body class="text-center">
        ...
        <header class="masthead d-flex w-100 p-3 mx-auto flex-column">
            <div class="inner">
                ...
                <nav class="nav nav-masthead justify-content-center">
                    <a class="nav-link" href="./index.php">Desimal - Base62</a>
                    <a class="nav-link active" style="cursor: pointer;">Base62 - Desimal</a>
                </nav>
            </div>
        </header>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <form action="" method="post" id="decode">
                        <h1 class="cover-heading">Input Base62</h1>
                        <textarea autofocus cols="30" rows="5" type="text" name="base62" id="base62" class="d-flex border border-light rounded w-100 px-3 py-1 bg-my font-larger"><?= $char; ?></textarea>
                        <p class="lead mt-3">
                        <div class="row my-3">
                            <div class="col-3">
                ...
                <div class="col-12 col-md-6">
                    <h1 class="cover-heading">Output Desimal</h1>
                    <textarea disabled cols="30" rows="5" type="text" name="desimal" id="desimal" class="d-flex border border-light rounded w-100 px-3 py-1 bg-my font-larger"><?= $base62->encodeBase62($char); ?></textarea>
    ...
    <script>
        ...
        $("#copy").click(function() {
            ...
            container.value = $("#desimal").val(); //save main text in it
        ...
        $("#base62").keyup(function() {
            ...
            $.ajax({
                type: 'POST',
                url: './api/decode.php',
                data: $('#decode').serialize(),
                success: function(data) {
                    $('#desimal').html(data).show();
                }
            });
        });
    </script>
